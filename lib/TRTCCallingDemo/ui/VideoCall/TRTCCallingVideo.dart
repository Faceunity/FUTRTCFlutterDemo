...
import 'package:trtc_scenes_demo/FaceUnityUI/lib/Faceunity_ui.dart';
...
class _TRTCCallingVideoState extends State<TRTCCallingVideo> {
  ...
  //设置本地流代理
  setLocalDelegate() async {
    if (_remoteUserInfo != null) {
      if (_bigVideoViewId != -1) {
        await _tRTCCallingService.setLocalVideoRenderListener(
          _remoteUserInfo!.userId,
          _isFrontCamera,
          TRTCCloudDef.TRTC_VIDEO_STREAM_TYPE_SMALL,
          // ignore: unnecessary_null_comparison
          _screenWidth != null ? _screenWidth!.toInt() : 375,
          _screenHeight != null ? _screenHeight!.toInt() : 812,
        );
      }
    }
  }
